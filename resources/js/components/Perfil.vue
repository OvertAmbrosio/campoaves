            ...
            <div class="col-md-12 mt-3">
               <div class="card card-widget widget-user">
                  ...
                  <div class="widget-user-image">
                     <img class="img-circle" :src="getProfilePhoto()" alt="Foto de Perfil">
                  </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header p-2">
                        ...
                        <li class="nav-item"><a class="nav-link active show" href="#settings" data-toggle="tab">Configuración</a></li>
                        </ul>
                    </div><!-- /.card-header -->
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="file" @change="updatePerfil" name="photo" class="form-input">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label">Contraseña (dejar en blanco si no desea cambiarlo)</label>
...
<script>
    export default {
        ...
        methods:{
            getProfilePhoto(){
                var foto = this.form.photo;
                let imagen = "/img/perfil/"+ foto;
                return imagen;
            },
            updateInfo(){
                this.$Progress.start();
